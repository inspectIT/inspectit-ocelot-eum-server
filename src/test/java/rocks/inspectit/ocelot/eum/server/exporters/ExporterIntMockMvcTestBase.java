...
import rocks.inspectit.ocelot.eum.server.rest.TraceController;
...
public class ExporterIntMockMvcTestBase {
    ...
    /**
     * Posts a {@code Span} to {@link TraceController#spans(String)}
     *
    ...
    /**
     * Posts {@code Span}s to {@link TraceController#spans(String)}.
