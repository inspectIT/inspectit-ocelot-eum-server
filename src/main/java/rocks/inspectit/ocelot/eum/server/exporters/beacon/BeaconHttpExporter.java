...
import rocks.inspectit.ocelot.eum.server.configuration.model.exporters.beacon.BeaconHttpExporterSettings;
...
@ConditionalOnExpression("NOT new String('${inspectit-eum-server.exporters.beacons.http.enabled}').toUpperCase().equals(T(rocks.inspectit.ocelot.eum.server.configuration.model.exporters.ExporterEnabledState).DISABLED.toString())")
